...
var Module = typeof Walle !== 'undefined' ? Walle : {};
...
var wasmBinaryFile = 'libmain.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=22448;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function(e) {
...
var real__emscripten_bind_MainClass_DoTest_0 = asm["_emscripten_bind_MainClass_DoTest_0"]; asm["_emscripten_bind_MainClass_DoTest_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_MainClass_DoTest_0.apply(null, arguments);
};

var real__emscripten_bind_MainClass_MainClass_0 = asm["_emscripten_bind_MainClass_MainClass_0"]; asm["_emscripten_bind_MainClass_MainClass_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_MainClass_MainClass_0.apply(null, arguments);
};

var real__emscripten_bind_MainClass___destroy___0 = asm["_emscripten_bind_MainClass___destroy___0"]; asm["_emscripten_bind_MainClass___destroy___0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_MainClass___destroy___0.apply(null, arguments);
};
...
var _emscripten_bind_MainClass_DoTest_0 = Module["_emscripten_bind_MainClass_DoTest_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_MainClass_DoTest_0"].apply(null, arguments) };
var _emscripten_bind_MainClass_MainClass_0 = Module["_emscripten_bind_MainClass_MainClass_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_MainClass_MainClass_0"].apply(null, arguments) };
var _emscripten_bind_MainClass___destroy___0 = Module["_emscripten_bind_MainClass___destroy___0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_MainClass___destroy___0"].apply(null, arguments) };
...
// MainClass
/** @suppress {undefinedVars, duplicate} */function MainClass() {
  this.ptr = _emscripten_bind_MainClass_MainClass_0();
  getCache(MainClass)[this.ptr] = this;
};;
MainClass.prototype = Object.create(WrapperObject.prototype);
MainClass.prototype.constructor = MainClass;
MainClass.prototype.__class__ = MainClass;
MainClass.__cache__ = {};
Module['MainClass'] = MainClass;

MainClass.prototype['DoTest'] = MainClass.prototype.DoTest = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  return UTF8ToString(_emscripten_bind_MainClass_DoTest_0(self));
};;

  MainClass.prototype['__destroy__'] = MainClass.prototype.__destroy__ = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  _emscripten_bind_MainClass___destroy___0(self);
};
(function() {
  function setupEnums() {
